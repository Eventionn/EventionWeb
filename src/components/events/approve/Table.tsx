                            ...
                            <TableRow key={order.id}>
                                ...
                                <TableCell className="relative">
                                    ...
                                    >
                                        ...
                                        <DropdownItem onItemClick={closeDropdown} className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300">Reject</DropdownItem>
                                        <DropdownItem onItemClick={closeDropdown} className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300">Approve</DropdownItem>
                                    </Dropdown>
                                </TableCell>
                            </TableRow>
                        ))}
